...
class EnhancedEdgeDetector:
    ...
    def __init__(self):
        ...
        # 轮廓过滤参数
        self.min_area_ratio = 0.7  # 内容区域至少占总面积的70%
    ...
    def _detect_content_area_enhanced(self, gray: np.ndarray, 
        ...
        # 方法1：多算法边缘检测
        edges = self._multi_algorithm_edge_detection(gray)
        ...
        # 过滤轮廓
        filtered_contours = self._filter_contours(contours, w, h)
        ...
        # 找到最可能的内容区域轮廓
        content_contour = self._find_content_contour(filtered_contours, w, h, mode)
    ...
    def _find_content_contour(self, contours: List[np.ndarray], 
